...
exp_df = pd.read_csv("/rds/project/rds-C9woKbOCf2Y/lk530/T_cell_infection_atlas/Multi_milo/Manuscript_final/milo_experiment_plan_CD8_fig2.csv")
...
# *** CD8-specific: Subset to CD8 T cells ***
adata = adata[adata.obs.annotation_level_1 == 'T CD8']
...
for annotation in ['annotation_level_3']:
    ...
    # *** CD8-specific: output path ***
    df.to_csv(f'/rds/project/rds-C9woKbOCf2Y/lk530/T_cell_infection_atlas/Multi_milo/Manuscript_final/Fig_2/results_CD8_{exp["id"]}.csv')
